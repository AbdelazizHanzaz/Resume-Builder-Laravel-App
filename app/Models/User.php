...
class User extends Authenticatable
{
    ...
    protected $casts = [
     ...
     // Resume templates associated with the user
     public function resumeTemplates()
     {
         return $this->hasMany(ResumeTemplate::class);
     }
 
     // Resume sections associated with the user
     public function resumeSections()
     {
         return $this->hasMany(ResumeSection::class);
     }
 
     // Resume fields associated with the user
